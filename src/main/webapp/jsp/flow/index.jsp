...
<head>
	...
	<link rel="stylesheet" href="css/flow/index.css" />
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="images/flow/banner1.jpg" alt="...">
						</div>
						<div class="item">
							<img src="images/flow/banner2.jpg" alt="...">
						</div>
						<div class="item">
							<img src="images/flow/banner3.jpg" alt="...">
						</div>
				...
				<div class="row">
					...
					<div class="search col-md-4 col-md-offset-6" style="margin-top:20px;">
						<div class="input-group">
							<form action="FlowList2" method="get">
					...
					<div class="col-md-10 main-right" style="margin-top:-52px;">
						<div class="pro col-md-12">
							<h3>推荐鲜花</h3>
							<div id="recFlows" class="pro-list">
								<ul> 
						...
						<div class="pro col-md-12">
							<h3>新品上市</h3>
							<div id="newFlows" class="pro-list">
								<ul > 
