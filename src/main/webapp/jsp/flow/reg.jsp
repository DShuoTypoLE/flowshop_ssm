...
<head>
	...
	<script type="text/javascript" src="js/flow/user_reg_login.js" charset="UTF-8"></script>
	<script type="text/javascript" src="js/flow/landing.js"></script>
	<link href="css/flow/head_footer.css" rel="stylesheet" type="text/css">
	<link href="css/flow/user_reg_login.css" rel="stylesheet" type="text/css">
...
<c:if test="${!empty infoList}">
	...
	<div>
		...
		<div class="wrapper" style="background:url(images/flow/loginbg.jpg);margin-top:-20px;background-repeat:no-repeat;background-size:cover;">
			<!-- main start -->
...
<%--									<span id="findUser" class="Validform_checktip">*用户名以字母开头，4-8个字符</span>--%>
...
// 	$.ajax({
// 		url:"UserServlet?username="+this.value+"&action=ajaxFind",
// 		dataType:"json",
// 		async:true,
// 		data:{},
// 		type:"POST",
...
// 			if (data.info == "true"){
// 				$("#findUser").empty();
// 				$("#findUser").html("<font color='red' style='font-size: 10px'>用户名已存在</font>");
// 			}else if(data.info == "false"){
// 				$("#findUser").empty();
// 				$("#findUser").html("<font color='green' style='font-size: 10px'>用户名可以注册</font>");
// 			}else if (data.info == "other"){
// 				$("#findUser").empty();
// 				$("#findUser").html("<font color='green' style='font-size: 10px'>请填写用户信息</font>");
// 			}
//
// 		}
//
