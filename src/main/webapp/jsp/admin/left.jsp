	...
	<div class="left">
		<ul>
			<li class="list">
				<h3>地 区 管 理</h3>
				<ul>
					<li><a href="jsp/admin/AddressServlet?action=edit" target="rFrame">配送位置管理</a></li>
				</ul>
			</li>
			<li class="list">
				<h3>用 户 管 理</h3>
			...
			<li class="list">
				<h3>花 卉 管 理</h3>
				<ul>
					<li><a href="jsp/admin/FlowManageServlet?action=list" target="rFrame">花卉列表</a></li>
				</ul>
			</li>
			<li class="list">
				<h3>分 类 管 理</h3>
			...
			<li class="list">
				<h3>配送员管理</h3>
				<ul>
					<li><a href="jsp/admin/ChargerServlet?action=list" target="rFrame">配送员管理</a></li>
				</ul>
			</li>
			<li class="list">
				<h3>留 言 管 理</h3>
				<ul>
					<li><a href="jsp/admin/MsgServlet?action=list" target="rFrame">留言列表</a></li>
				</ul>
			</li>
		</ul>
	</div>
